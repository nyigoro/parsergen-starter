...
const renderSurface = {
  ...
  createResource: render.resource_create, resourceStatus: render.resource_status, resourceData: render.resource_data, resourceError: render.resource_error, resourceRead: render.resource_read, resourceRefresh: render.resource_refresh, resourceInvalidate: render.resource_invalidate, resourceInvalidateKey: render.resource_invalidate_key, resourceInvalidatePrefix: render.resource_invalidate_prefix, resourceInvalidateTag: render.resource_invalidate_tag, resourceClearCache: render.resource_clear_cache, resourceMutate: render.resource_mutate,
...
export const {
  ...
  state,
  remember,
  createResource, resourceStatus, resourceData, resourceError, resourceRead, resourceRefresh, resourceInvalidate, resourceInvalidateKey, resourceInvalidatePrefix, resourceInvalidateTag, resourceClearCache, resourceMutate,
  suspense,
  errorBoundary,
  show,
  mountApp,
