...
const renderSurface = {
  ...
  createResource: render.resource_create, resourceStatus: render.resource_status, resourceData: render.resource_data, resourceError: render.resource_error, resourceRead: render.resource_read, resourceRefresh: render.resource_refresh, resourceSubmit: render.resource_submit, resourceSubmitOptimistic: render.resource_submit_optimistic, resourceInvalidate: render.resource_invalidate, resourceInvalidateKey: render.resource_invalidate_key, resourceInvalidatePrefix: render.resource_invalidate_prefix, resourceInvalidateTag: render.resource_invalidate_tag, resourceInvalidateDependency: render.resource_invalidate_dependency, resourceInvalidateScope: render.resource_invalidate_scope, resourceInvalidateRequest: render.resource_invalidate_request, resourceClearCache: render.resource_clear_cache, resourceClearScope: render.resource_clear_scope, resourceClearRequest: render.resource_clear_request, resourceMutate: render.resource_mutate,
