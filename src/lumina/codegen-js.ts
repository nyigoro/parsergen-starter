...
class JSGenerator {
  ...
  emitProgram(node: LuminaProgram): void {
    if (this.includeRuntime) {
      if (this.target === 'cjs') {
        this.builder.append(
          'const { io, str, math, list, vec, hashmap, fs, http, Result, Option, __set, formatValue, LuminaPanic } = require("./lumina-runtime.cjs");'
        );
      } else {
        this.builder.append(
          'import { io, str, math, list, vec, hashmap, fs, http, Result, Option, __set, formatValue, LuminaPanic } from "./lumina-runtime.js";'
        );
      }
    } else {
    ...
    if (this.includeRuntime) {
      if (this.target === 'cjs') {
        this.builder.append('module.exports = { io, str, math, list, vec, hashmap, fs, http, Result, Option, __set, formatValue, LuminaPanic };');
      } else {
        this.builder.append('export { io, str, math, list, vec, hashmap, fs, http, Result, Option, __set, formatValue, LuminaPanic };');
      }
    } else {
      if (this.target === 'cjs') {
