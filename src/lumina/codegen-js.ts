...
class JSGenerator {
  ...
  emitProgram(node: LuminaProgram): void {
    ...
    if (this.includeRuntime) {
      ...
      if (this.target === 'cjs') {
        this.builder.append('module.exports = { io, str, math, fs, path, env, process, json, http, time, join_all, timeout, async_channel, regex, crypto, functor, applicative, monad, foldable, traversable, __set, __lumina_stringify, __lumina_range, __lumina_slice, __lumina_index, __lumina_fixed_array, __lumina_array_bounds_check, __lumina_array_literal, __lumina_clone, __lumina_debug, __lumina_eq, __lumina_struct, __lumina_register_trait_impl };');
      } else {
        this.builder.append('export { io, str, math, fs, path, env, process, json, http, time, join_all, timeout, async_channel, regex, crypto, functor, applicative, monad, foldable, traversable, __set, __lumina_stringify, __lumina_range, __lumina_slice, __lumina_index, __lumina_fixed_array, __lumina_array_bounds_check, __lumina_array_literal, __lumina_clone, __lumina_debug, __lumina_eq, __lumina_struct, __lumina_register_trait_impl };');
      }
    }
    this.builder.append('\n');
  }
