  ...
  const renderModule: ModuleNamespace = (() => {
    ...
    return {
      ...
      exports: new Map([
        ...
        ['resourceInvalidateRequest', moduleFunctionWithScheme('resourceInvalidateRequest', ['string'], 'int', schemeFromVars(resourceInvalidatePrefixType, []), ['requestId'], 'std://render')],
