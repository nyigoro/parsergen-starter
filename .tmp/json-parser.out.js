...
function lex(input) {
  ...
  switch (__match_tag_1) {
    case "Ok": {
      ...
      return { $tag: "Ok", $payload: list_reverse_tokens_into(tokens, { $tag: "Nil" }) };
      break;
    }
    case "Err": {
...
function list_reverse_tokens(list) {
  return list_reverse_tokens_into(list, { $tag: "Nil" });
}
        ...
        case "Ok": {
          ...
          switch (__match_tag_51) {
            case "Ok": {
              ...
              return { $tag: "Ok", $payload: __lumina_struct("ParseResult", { value: { $tag: "Object", $payload: list_reverse_entries_into(members_res.members, { $tag: "Nil" }) }, rest: rest }) };
              break;
            }
            case "Err": {
        ...
        case "Ok": {
          ...
          switch (__match_tag_67) {
            case "Ok": {
              ...
              return { $tag: "Ok", $payload: __lumina_struct("ParseResult", { value: { $tag: "Array", $payload: list_reverse_values_into(elems_res.elements, { $tag: "Nil" }) }, rest: rest }) };
              break;
            }
            case "Err": {
...
function list_reverse_entries(list) {
  return list_reverse_entries_into(list, { $tag: "Nil" });
}
...
function list_reverse_values(list) {
  return list_reverse_values_into(list, { $tag: "Nil" });
}
...
function stringify_indent(value, indent) {
  ...
  switch (__match_tag_97) {
    ...
    case "String": {
      ...
      return str.concat(str.concat("\"", escape_string_at(s, 0, "")), "\"");
      break;
    }
    case "Array": {
...
function stringify_members(members, indent, first) {
  ...
  switch (__match_tag_107) {
    ...
    case "Cons": {
      ...
      const prefix = prefix_for(first);
      const key_str = str.concat(str.concat("\"", escape_string_at(head.key, 0, "")), "\"");
...
function process_input(input) {
  ...
  switch (__match_tag_115) {
    case "Ok": {
      ...
      io.println(stringify_indent(value, 0));
      io.println("");
      break;
    }
    case "Err": {
