...
var isVNode = /* @__PURE__ */ __name((value) => {
  if (!value || typeof value !== "object") return false;
  const candidate = value;
  return candidate.kind === "text" || candidate.kind === "live_text" || candidate.kind === "index_list" || candidate.kind === "element" || candidate.kind === "fragment" || candidate.kind === "portal";
}, "isVNode");
...
var readIndexListValues = /* @__PURE__ */ __name((signal, tracked) => {
  const value = tracked ? signal.get() : signal.peek();
  if (Array.isArray(value)) return value;
  if (value && typeof value === "object") {
    const iterator = value[Symbol.iterator];
    if (typeof iterator === "function") {
...
var hasStableKeyedChildOrder = /* @__PURE__ */ __name((prevChildren, nextChildren) => {
  if (prevChildren.length !== nextChildren.length) return false;
  if (prevChildren.length === 0) return false;
  ...
  for (let i = 0; i < prevChildren.length; i += 1) {
    ...
    if (seenKeys.has(prevChild.key) || seenKeys.has(nextChild.key)) {
      throw duplicateKeyError(nextChild.key);
    }
    seenKeys.add(prevChild.key);
    if (prevChild.key !== nextChild.key) {
      return false;
    }
  }
  return true;
}, "hasStableKeyedChildOrder");
...
var bindIndexListHost = /* @__PURE__ */ __name((host, node, documentLike, eventStore, portalStore, liveTextStore) => {
  ...
  host.__luminaIndexListEffect?.dispose();
  let itemSignals = readIndexListValues(source, false).map((value) => new Signal(value));
...
var patchDomChildrenWithKeys = /* @__PURE__ */ __name((element, prevChildren, nextChildren, documentLike, eventStore, portalStore, liveTextStore) => {
  if (hasStableKeyedChildOrder(prevChildren, nextChildren)) {
...
var reorderChildren = /* @__PURE__ */ __name((container, children2, eventStore, portalStore, liveTextStore) => {
  ...
  for (let index = 0; index < children2.length; index += 1) {
    ...
    container.insertBefore(nextChild, currentChild);
  }
}, "reorderChildren");
